...
jQuery.validator.addMethod("studentNumber", function(value, element){
	return this.optional(element) || value.length >= 7;
}, "Please enter a student number of atleast 7 digits or greater");
//validate SA phone number length
jQuery.validator.addMethod("saPhoneNumber", function(value, element){
	return this.optional(element) || value.length ==10;
}, "Please enter a 10 digit phone number e.g 072xxxxxxx");
//validate city name
...
}, "Letters and numbers for Passport / numbers only for ID please");

jQuery.validator.addMethod("lettersonly", function(value, element) {
	return this.optional(element) || /^[a-z]+$/i.test(value);
}, "Please enter Letters only, no spaces or numbers or special characters");
