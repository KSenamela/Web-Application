<?php
  ...
  if(isset($_GET['edit'])){
    ...
    $edit = $_GET['edit'];
    $sql = "SELECT * FROM recruiter_application WHERE id_number = '$edit'";
  ...
  if(isset($_POST['idnumber'])){
    ...
    $updateStudent = "UPDATE student_application SET first_name = '$first_name' , last_name = '$last_name', email = '$email', phone = '$phone', gender = '$gender', race = '$race', street = '$street', city = '$city', province = '$province', postal_code = '$postal_code', country = '$country', kin_name = '$kin_name', kin_number = '$kin_phone' WHERE id_number = '$id_number'";
  ...
  if (!$conn){
    ...
    $getEmail = mysqli_query($conn, "SELECT * FROM recruiter_application WHERE id_number = '$id_number'");
